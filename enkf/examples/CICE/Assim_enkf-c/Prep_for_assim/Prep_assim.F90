program Prep_assim
	...
	use Global_variables, only: nx, ny, Ensemble_dir, restart_dir, cat_sum, ens_size, get_date
	...
	do member = 1,ens_size
		...
		if(member < 10) then
			write( str, '(I1)' ) member
			str3 = '00' // str
			filein_ice = Restart_dir // 'Ens' // str // '/restart/iced.' // trim(date) //'.nc'
		elseif (member > 9 .and. member < 100) then
			write( str2 , '(I2)' ) member
			str3 = '0' // str2
			filein_ice = Restart_dir // 'Ens' // str2 // '/restart/iced.' // trim(date) //'.nc'
		else
	...
	call create_nc(Ensemble_dir // 'mem' // str3 // '_sst.nc', 'sst',  1)
	call create_nc(Ensemble_dir // 'mem' // str3 // '_frzmlt.nc', 'frzmlt', 1)
	call create_nc(Ensemble_dir // 'mem' // str3 // '_frz_onset.nc', 'frz_onset', 1)
	...
	call write_var_nc(Ensemble_dir // 'mem' // str3 // '_sst.nc', 'sst', 1, 2, sst)
	call write_var_nc(Ensemble_dir // 'mem' // str3 // '_frzmlt.nc', 'frzmlt', 1, 2, frzmlt)
	call write_var_nc(Ensemble_dir // 'mem' // str3 // '_frz_onset.nc', 'frz_onset', 1, 2, frz_onset)
