program Consistency
	...
	do member = 1,ens_size
		...
		if(member < 10) then
			write( str, '(I1)' ) member
			str3 = '00' // str
			fileout_ice = Restart_dir // 'Ens' // str // '/restart/this_day.nc'
		elseif (member > 9 .and. member < 100) then
			write( str2 , '(I2)' ) member
			str3 = '0' // str2
			fileout_ice = Restart_dir // 'Ens' // str2 // '/restart/this_day.nc'
		else
	...
	call generic_check_2d('vvel',vvel,aicensum,vvel_org)
        ...
        !stress12_1=stress12_1_org
        !stress12_2=stress12_2_org
        !stress12_3=stress12_3_org
        !stress12_4=stress12_4_org
        !stressm_1=stressm_1_org
        !stressm_2=stressm_2_org
        !stressm_3=stressm_3_org
        !stressm_4=stressm_4_org
        !stressp_1=stressp_1_org
        !stressp_2=stressp_2_org
        !stressp_3=stressp_3_org
        !stressp_4=stressp_4_org
        !strocnxT=strocnxT_org
        !strocnyT=strocnyT_org
        !swidf=swidf_org
        !swidr=swidr_org
        !swvdf=swvdf_org
        !swvdr=swvdr_org
