module read_write_nc	
	...
	subroutine create_res_nc(FILE_NAME)
		
		character(len=*), intent(in) 			:: FILE_NAME
		integer 					:: ncid, varid, dimids(3), dimids2(2), dimids3(3)
  		integer 					:: x_dimid, y_dimid, z_dimid, n_dimid

		call check( nf90_create(FILE_NAME, NF90_CLOBBER, ncid) )
		call check( nf90_def_dim(ncid, "x", NX, x_dimid) )
		call check( nf90_def_dim(ncid, "y", NY, y_dimid) )
		call check( nf90_def_dim(ncid, "z", 5, z_dimid) )
		call check( nf90_def_dim(ncid, "Ens", Nens, n_dimid) )
		dimids =  (/ x_dimid, y_dimid, n_dimid /)
		dimids2 =  (/ x_dimid, y_dimid/)
		dimids3 =  (/ x_dimid, y_dimid, z_dimid/)

		call check( nf90_def_var(ncid, "Ens_before", NF90_REAL, dimids, varid) )
		call check( nf90_def_var(ncid, "Ens_after", NF90_REAL, dimids, varid) )
		call check( nf90_def_var(ncid, "mem001_before", NF90_REAL, dimids3, varid) )
		call check( nf90_def_var(ncid, "mem001_after", NF90_REAL, dimids3, varid) )
		call check( nf90_def_var(ncid, "Obs", NF90_REAL, dimids2, varid) )
		
		call check( nf90_enddef(ncid) ) 		
		call check( nf90_close(ncid) )

	end subroutine create_res_nc

	subroutine create_nc(FILE_NAME,VAR_NAME, zdim)
		...
		call check( nf90_create(FILE_NAME, NF90_CLOBBER, ncid) )
		call check( nf90_def_dim(ncid, "i", NX, x_dimid) )
		call check( nf90_def_dim(ncid, "j", NY, y_dimid) )
		call check( nf90_def_dim(ncid, "k", zdim, z_dimid) )
