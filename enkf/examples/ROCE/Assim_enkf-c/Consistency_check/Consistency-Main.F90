program Consistency
	...
	use Global_variables, only: Analyse_dir, nx, ny, ens_size, Restart_dir
	...
	fileout_ocn = Restart_dir // 'ocean_mem' // str3 // '.nc'
	
	print*, Analyse_dir // 'mem' // str3 //'_aicen.nc.analysis'

	! Read analysis results 2d ice
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_aice.nc.analysis', 'accum_aice',  1, 2, accum_aice)
	print*, Analyse_dir // 'mem' // str3 //'_aicen.nc.analysis'
        call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_fhocn.nc.analysis', 'accum_fhocn',  1, 2, accum_fhocn)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_fresh.nc.analysis', 'accum_fresh',  1, 2, accum_fresh)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_fsalt.nc.analysis', 'accum_fsalt',  1, 2, accum_fsalt)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_fswthru.nc.analysis', 'accum_fswthru',  1, 2, accum_fswthru)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_strocnx.nc.analysis', 'accum_strocnx',  1, 2, accum_strocnx)
	...
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_temp.nc.analysis', 'temp',  35, 3, temp)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_salt.nc.analysis', 'salt',  35, 3, salt)


	! Read original values
	! Read analysis results 2d ice
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_aice.nc', 'accum_aice',  1, 2, accum_aice_org)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_fhocn.nc', 'accum_fhocn',  1, 2, accum_fhocn_org)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_fresh.nc', 'accum_fresh',  1, 2, accum_fresh_org)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_fsalt.nc', 'accum_fsalt',  1, 2, accum_fsalt_org)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_fswthru.nc', 'accum_fswthru',  1, 2, accum_fswthru_org)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_accum_strocnx.nc', 'accum_strocnx',  1, 2, accum_strocnx_org)
	...
	! Read analysis results 3d ocn
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_temp.nc', 'temp',  35, 3, temp_org)
	call read_var_nc(Analyse_dir // 'mem' // str3 //'_salt.nc', 'salt',  35, 3, salt_org)
